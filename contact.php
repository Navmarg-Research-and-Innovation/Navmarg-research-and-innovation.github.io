...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $maxSubmissionsEmail = 3; // Maximum allowed submissions by email in the time window
    $maxSubmissionsIP = 3; // Maximum allowed submissions by IP address in the time window
